...
usage = "usage: run from Timing-TOFPET: \n python run_DAQ_alignSingleBar.py -c config_main_bar.txt -o /media/cmsdaq/ext/data/ALIGNMENT/ALIGNBAR_14_02_2020 -n ALIGNBAR" 
...
dict_PosScan = {
    ...
    ##ALIGN BAR Y
    0: (round(posRefX,1),round(posRefY-12.0,1),"0_1_2","0_0_0","20_10_10"),
    1: (round(posRefX,1),round(posRefY-8.0,1),"0_1_2","0_0_0","20_10_10"),
    2: (round(posRefX,1),round(posRefY-4.0,1),"0_1_2","0_0_0","20_10_10"),
    3: (round(posRefX,1),round(posRefY-3.5,1),"0_1_2","0_0_0","20_10_10"),
    4: (round(posRefX,1),round(posRefY-3.0,1),"0_1_2","0_0_0","20_10_10"),
    5: (round(posRefX,1),round(posRefY-2.5,1),"0_1_2","0_0_0","20_10_10"),
    6: (round(posRefX,1),round(posRefY-2.0,1),"0_1_2","0_0_0","20_10_10"),
    7: (round(posRefX,1),round(posRefY-1.5,1),"0_1_2","0_0_0","20_10_10"),
    8: (round(posRefX,1),round(posRefY-1.0,1),"0_1_2","0_0_0","20_10_10"),
    9: (round(posRefX,1),round(posRefY-0.5,1),"0_1_2","0_0_0","20_10_10"),
    10: (round(posRefX,1),round(posRefY,1),"0_1_2","0_0_0","20_10_10"),
    11: (round(posRefX,1),round(posRefY+0.5,1),"0_1_2","0_0_0","20_10_10"),
    12: (round(posRefX,1),round(posRefY+1.0,1),"0_1_2","0_0_0","20_10_10"),
    13: (round(posRefX,1),round(posRefY+1.5,1),"0_1_2","0_0_0","20_10_10"),
    14: (round(posRefX,1),round(posRefY+2.0,1),"0_1_2","0_0_0","20_10_10"),
    15: (round(posRefX,1),round(posRefY+2.5,1),"0_1_2","0_0_0","20_10_10"),
    16: (round(posRefX,1),round(posRefY+3.0,1),"0_1_2","0_0_0","20_10_10"),
    17: (round(posRefX,1),round(posRefY+3.5,1),"0_1_2","0_0_0","20_10_10"),
    18: (round(posRefX,1),round(posRefY+4.0,1),"0_1_2","0_0_0","20_10_10"),
    19: (round(posRefX,1),round(posRefY+8.0,1),"0_1_2","0_0_0","20_10_10"),
    20: (round(posRefX,1),round(posRefY+12.0,1),"0_1_2","0_0_0","20_10_10"),

    ##ALIGN BAR X
    21: (round(posRefX-15.0,1),round(posRefY,1),"0_1_2","0_0_0","20_10_10"),
    22: (round(posRefX-12.0,1),round(posRefY,1),"0_1_2","0_0_0","20_10_10"),
    23: (round(posRefX-9.0,1),round(posRefY,1),"0_1_2","0_0_0","20_10_10"),
    24: (round(posRefX-6.0,1),round(posRefY,1),"0_1_2","0_0_0","20_10_10"),
    25: (round(posRefX-4.0,1),round(posRefY,1),"0_1_2","0_0_0","20_10_10"),
    26: (round(posRefX-2.0,1),round(posRefY,1),"0_1_2","0_0_0","20_10_10"),
    27: (round(posRefX,1),round(posRefY,1),"0_1_2","0_0_0","20_10_10"),
    28: (round(posRefX+2.0,1),round(posRefY,1),"0_1_2","0_0_0","20_10_10"),
    29: (round(posRefX+4.0,1),round(posRefY,1),"0_1_2","0_0_0","20_10_10"),
    30: (round(posRefX+6.0,1),round(posRefY,1),"0_1_2","0_0_0","20_10_10"),
    31: (round(posRefX+9.0,1),round(posRefY,1),"0_1_2","0_0_0","20_10_10"),
    32: (round(posRefX+12.0,1),round(posRefY,1),"0_1_2","0_0_0","20_10_10"),
    33: (round(posRefX+15.0,1),round(posRefY,1),"0_1_2","0_0_0","20_10_10")
