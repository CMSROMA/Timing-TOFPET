...
crystalsData.ReadFile("DB/lyDB_SiPM.csv","name/C:prod/C:type/C:id/I:geo/C:tag/C:temp/F:barID/I:posX/F:posY/F:ly/F:ctr/F:lyRef/F:ctrRef/F:xtLeft/F:xtRight/F");
pixelRes = 90 #ps
outputdir = "plots"
...
for g in graphs:
    ...
    for prod in producersJuly20:
        ...
        if(prodN==12):
            colorProd = 50
        histos['2D_'+g+'_forProd_'+prod].SetMarkerColor(colorProd)
        histos['2D_'+g+'_forProd_'+prod].SetLineColor(colorProd)
...
h1.GetYaxis().SetTitle("LO [ADC counts]")
...
legend1.Clear()
legend1.AddEntry(histos['ly'+'VsProd'],"Array No Irrad.","pe")
legend1.Draw()
...
h1.GetXaxis().SetRangeUser(0,13)
h1.GetYaxis().SetTitle("LO / LO_{ref}")
h1.GetXaxis().SetTitle("Prod. ID")
h1.Draw("hist")
...
legend1.Clear()
legend1.AddEntry(histos['lyNorm'+'VsProd'],"Array No Irrad.","pe")
legend1.Draw()
text1.DrawLatexNDC(0.11,0.93,"CMS Rome - TOFPET+SiPM Bench")
for ext in ['.pdf','.png']:
...
legend1.AddEntry(histos['lyIRR'+'VsProd'],"Array Irrad. 45-50 kGy","pe")
for ext in ['.pdf','.png']:
...
legend1.Clear()
legend1.AddEntry(histos['sigmat'+'VsProd'],"Array No Irrad.","pe")
legend1.Draw()
text1.DrawLatexNDC(0.11,0.93,"CMS Rome - TOFPET+SiPM Bench")
for ext in ['.pdf','.png']:
...
legend1.AddEntry(histos['sigmatIRR'+'VsProd'],"Array Irrad. 45-50 kGy","pe")
for ext in ['.pdf','.png']:
...
legend1.Clear()
legend1.AddEntry(histos['sigmatNorm'+'VsProd'],"Array No Irrad.","pe")
legend1.Draw()
text1.DrawLatexNDC(0.11,0.93,"CMS Rome - TOFPET+SiPM Bench")
for ext in ['.pdf','.png']:
...
legend1.AddEntry(histos['sigmatNormIRR'+'VsProd'],"Array Irrad. 45-50 kGy","pe")
for ext in ['.pdf','.png']:
...
legend1.Clear()
legend1.AddEntry(histos['xt'+'VsProd'],"Array No Irrad.","pe")
legend1.Draw()
text1.DrawLatexNDC(0.11,0.93,"CMS Rome - TOFPET+SiPM Bench")
for ext in ['.pdf','.png']:
...
legend1.AddEntry(histos['xtIRR'+'VsProd'],"Array Irrad. 45-50 kGy","pe")
for ext in ['.pdf','.png']:
...
h2.GetYaxis().SetTitle("LO_{IRR} / LO ")
h2.GetYaxis().SetTitleOffset(0.5*h2.GetYaxis().GetTitleOffset())
...
c1_pad1.SetGridy()
h1=R.TH1F("h1","h1",12,0,13)
h1.GetYaxis().SetRangeUser(0.65,1.3)
h1.GetXaxis().SetRangeUser(0,13)
h1.GetYaxis().SetTitle("LO / LO_{ref}")
h1.GetXaxis().SetTitle("Prod. ID")
h1.Draw("hist")
...
legend1.Clear()
legend1.AddEntry(histos['lyNorm'+'VsProd'],"Array No Irrad.","pe")
legend1.AddEntry(histos['lyNormIRR'+'VsProd'],"Array Irrad. 45-50 kGy","pe")
legend1.Draw()
text1.DrawLatexNDC(0.11,0.93,"CMS Rome - TOFPET+SiPM Bench")
c1_pad2.cd()
h2=R.TH1F("h1","h1",12,0,13)
h2.GetYaxis().SetRangeUser(0.7,1.1)
h2.GetYaxis().SetNdivisions(505)
h2.GetXaxis().SetRangeUser(0,13)
h2.GetYaxis().SetTitle("(LO/LO_{ref})_{IRR} / (LO/LO_{ref})")
h2.GetYaxis().SetTitleOffset(0.5*h2.GetYaxis().GetTitleOffset())
h2.GetYaxis().SetTitleSize(1.7*h2.GetYaxis().GetTitleSize())
h2.GetXaxis().SetTitleSize(1.7*h2.GetXaxis().GetTitleSize())
h2.GetYaxis().SetLabelSize(1.7*h2.GetYaxis().GetLabelSize())
...
c1_pad1.SetGridy()
h1=R.TH1F("h1","h1",12,0,13)
h1.GetYaxis().SetRangeUser(115,200)
h1.GetXaxis().SetRangeUser(0,13)
h1.GetYaxis().SetTitle("#sigma_{T} [ps]")
h1.GetXaxis().SetTitle("Prod. ID")
h1.Draw("hist")
...
c1_pad2.cd()
h2=R.TH1F("h1","h1",12,0,13)
h2.GetYaxis().SetRangeUser(0.8,1.35)
h2.GetYaxis().SetNdivisions(505)
h2.GetXaxis().SetRangeUser(0,13)
...
h1.GetYaxis().SetTitle("LO BARS [ADC counts]")
h1.GetYaxis().SetTitleOffset(1.3)
h1.GetXaxis().SetTitle("LO ARRAYS [ADC counts]")
h1.Draw("hist")
b=R.TF1("b2","x",40,130)
b.SetLineStyle(2)
b.SetLineColor(1)
...
h1.GetXaxis().SetRangeUser(0.8,1.3)
h1.GetYaxis().SetTitle("LO / LO_{ref} BARS ")
h1.GetYaxis().SetTitleOffset(1.3)
h1.GetXaxis().SetTitle("LO / LO_{ref} ARRAYS ")
h1.Draw("hist")
b=R.TF1("b2","x",0,2)
b.SetLineStyle(2)
b.SetLineColor(1)
