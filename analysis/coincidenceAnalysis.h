...
public :
   ...
   coincidenceAnalysis(TTree *tree=0);
...
coincidenceAnalysis::coincidenceAnalysis(TTree *tree) : fChain(0) 
{
...
Bool_t coincidenceAnalysis::Notify()
{
...
void coincidenceAnalysis::Show(Long64_t entry)
{
...
Int_t coincidenceAnalysis::Cut(Long64_t entry)
{
