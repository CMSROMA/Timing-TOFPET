...
#ifndef coincidenceAnalysisWithBarRef_h
#define coincidenceAnalysisWithBarRef_h
...
class coincidenceAnalysisWithBarRef {
public :
   int channels[34];
   ...
   coincidenceAnalysisWithBarRef(TTree *tree=0);
   virtual ~coincidenceAnalysisWithBarRef();
...
#ifdef coincidenceAnalysisWithBarRef_cxx
coincidenceAnalysisWithBarRef::coincidenceAnalysisWithBarRef(TTree *tree) : fChain(0) 
{
...
coincidenceAnalysisWithBarRef::~coincidenceAnalysisWithBarRef()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t coincidenceAnalysisWithBarRef::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t coincidenceAnalysisWithBarRef::LoadTree(Long64_t entry)
{
...
void coincidenceAnalysisWithBarRef::Init(TTree *tree)
{
...
Bool_t coincidenceAnalysisWithBarRef::Notify()
{
...
void coincidenceAnalysisWithBarRef::Show(Long64_t entry)
{
...
Int_t coincidenceAnalysisWithBarRef::Cut(Long64_t entry)
{
...
#endif // #ifdef coincidenceAnalysisWithBarRef_cxx
