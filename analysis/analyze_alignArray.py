...
usage = "usage: python analysis/analyze_alignArray.py -i /media/cmsdaq/ext/data/ALIGNMENT/ALIGNARRAY_11_02_2020 -o /media/cmsdaq/ext/data/ALIGNMENT/ALIGNARRAY_11_02_2020"
...
for file in list_allfiles:
    ...
    if ("_coincidences.root" in file):
        ...
        for event in range (0,tree.GetEntries()):
            ...
            if(tree.energy[0]>-9 and tree.energy[6]>-9 and tree.energy[22]>-9):
