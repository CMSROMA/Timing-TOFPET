...
#ifndef ctrAnalysisBar_h
#define ctrAnalysisBar_h
...
public :
    ...
    float pixel_511Peak_mean;
    float pixel_511Peak_sigma;
    
    float bar_511Peak_mean;
    float bar_511Peak_sigma;
   ...
   ctrAnalysisBar(TTree *tree=0);
   virtual ~ctrAnalysisBar();
...
#ifdef ctrAnalysisBar_cxx
ctrAnalysisBar::ctrAnalysisBar(TTree *tree) : fChain(0) 
{
...
ctrAnalysisBar::~ctrAnalysisBar()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ctrAnalysisBar::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ctrAnalysisBar::LoadTree(Long64_t entry)
{
...
void ctrAnalysisBar::Init(TTree *tree)
{
...
void ctrAnalysisBar::Show(Long64_t entry)
{
...
Int_t ctrAnalysisBar::Cut(Long64_t entry)
{
...
#endif // #ifdef ctrAnalysisBar_cxx
