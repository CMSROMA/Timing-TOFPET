...
#ifndef ctrAnalysis_h
#define ctrAnalysis_h
...
float alignedBar_511Peak_mean;
float alignedBar_511Peak_sigma;
...
#ifdef ctrAnalysis_cxx
ctrAnalysis::ctrAnalysis(TTree *tree) : fChain(0) 
{
...
Int_t ctrAnalysis::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ctrAnalysis::LoadTree(Long64_t entry)
{
...
void ctrAnalysis::Init(TTree *tree)
{
...
void ctrAnalysis::Show(Long64_t entry)
{
...
Int_t ctrAnalysis::Cut(Long64_t entry)
{
